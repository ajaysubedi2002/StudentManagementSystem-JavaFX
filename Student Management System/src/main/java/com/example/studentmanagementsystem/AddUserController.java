...
public class AddUserController implements Initializable {
    ...
    private String[] Roles = {"Teacher", "Librarian", "AdmissionOfficer"};
    ...
    protected void onSignup(ActionEvent actionEvent) throws IOException {
        ...
        String inputRole = Role.getValue();
        ...
        try (BufferedWriter csvWriter = new BufferedWriter(new FileWriter("Users.csv", true))) {
            csvWriter.write(userId + "," + inputEmail + "," + hashedPassword + "," + salt + "," + inputName + "," + inputGender + "," + inputRole);
            csvWriter.newLine();
        }
    }
